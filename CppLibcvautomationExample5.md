...
([C++](Cpp.htm)) [LibcvautomationExample5](CppLibcvautomationExample5.htm)
==========================================================================
...
GUI](CppLibcvautomationExample5.htm) is a
[libcvautomation](CppLibcvautomation.htm) example of a [Qt
Creator](CppQtCreator.htm) project with a basic GUI to give commands.
...
[Qt project file](CppQtProjectFile.htm): ./CppLibcvautomationExample5/CppLibcvautomationExample5.pro
----------------------------------------------------------------------------------------------------
