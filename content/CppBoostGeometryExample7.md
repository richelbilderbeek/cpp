...
([C++](Cpp.md)) [BoostGeometryExample7](CppBoostGeometryExample7.md)
======================================================================
...
boost::geometry::convex\_hull](CppBoostGeometryExample7.md) is a
...
[Qt project file](CppQtProjectFile.md): ./CppBoostGeometryExample7/CppBoostGeometryExample7.pro
------------------------------------------------------------------------------------------------
