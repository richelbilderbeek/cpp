...
([C++](Cpp.md)) [Resource](CppResource.md)
============================================

 

'A [resource](CppResource.md) is anything that has to be acquired and
...
-   Use [resource](CppResource.md) handles to manage resources
    ([RAII](CppRaii.md)) \[2\]
