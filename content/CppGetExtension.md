...
([C++](Cpp.md)) [GetExtension](CppGetExtension.md)
====================================================
...
[GetExtension](CppGetExtension.md) is a [file I/O](CppFileIo.md)
...
[Qt project file](CppQtProjectFile.md): ./CppGetExtension/CppGetExtension.pro
------------------------------------------------------------------------------
