...
([C++](Cpp.md)) [GetSmallestDouble](CppGetSmallestDouble.md)
==============================================================
...
[GetSmallestDouble](CppGetSmallestDouble.md) is a
[checking](CppCheck.md) [code snippet](CppCodeSnippets.md) to get the
smallest value of an [double](CppDouble.md).
...
[Qt project file](CppQtProjectFile.md): ./CppGetSmallestDouble/CppGetSmallestDouble.pro
----------------------------------------------------------------------------------------
