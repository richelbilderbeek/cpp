...
([C++](Cpp.md)) [Wt classes](CppWtClass.md)
=============================================

 

There are multiple types of [Wt classes](CppWtClass.md):

-   Official [Wt classes](CppWtClass.md): the [Wt](CppWt.md)
    [classes](CppClass.md) in the [Wt](CppWt.md)
    [namespace](CppNamespace.md)
-   Custom [Wt classes](CppWtClass.md): [classes](CppClass.md) that
    use [Wt](CppWt.md)
...
Official [Wt classes](CppWtClass.md)
-------------------------------------

 

These are the [Wt](CppWt.md) [classes](CppClass.md) in the
[Wt](CppWt.md) [namespace](CppNamespace.md).
...
-   [Wt::InvalidDateTimeException](CppInvalidDateTimeException.md)
-   [Wt::InvalidTimeException](CppInvalidTimeException.md)
-   [Wt::JSignal](CppJSignal.md)
-   [Wt::JSlot](CppJSlot.md)
-   [Wt::SignalBase](CppSignalBase.md)
-   [Wt::SyncLock](CppSyncLock.md)
-   [Wt::Touch](CppTouch.md)
...
-   [Wt::WAbstractItemView](CppWAbstractItemView.md)
-   [Wt::WAbstractListModel](CppWAbstractListModel.md)
-   [Wt::WAbstractProxyModel](CppWAbstractProxyModel.md)
-   [Wt::WAbstractTableModel](CppWAbstractTableModel.md)
-   [Wt::WAbstractToggleButton](CppWAbstractToggleButton.md)
-   [Wt::WAccordionLayout](CppWAccordionLayout.md)
-   [Wt::WAggregateProxyModel](CppWAggregateProxyModel.md)
-   [Wt::WAnchor](CppWAnchor.md)
-   [Wt::WApplication](CppWApplication.md)
-   [Wt::WBatchEditProxyModel](CppWBatchEditProxyModel.md)
...
-   [Wt::WCalendar](CppWCalendar.md)
-   [Wt::WCanvasPaintDevice](CppWCanvasPaintDevice.md)
-   [Wt::WCheckBox](CppWCheckBox.md)
-   [Wt::WCircleArea](CppWCircleArea.md)
-   [Wt::WColor](CppWColor.md)
-   [Wt::WCombinedLocalizedStrings](CppWCombinedLocalizedStrings.md)
-   [Wt::WComboBox](CppWComboBox.md)
-   [Wt::WCompositeWidget](CppWCompositeWidget.md)
-   [Wt::WContainerWidget](CppWContainerWidget.md)
-   [Wt::WCssDecorationStyle](CppWCssDecorationStyle.md)
-   [Wt::WCssRule](CppWCssRule.md)
-   [Wt::WCssStyleSheet](CppWCssStyleSheet.md)
-   [Wt::WCssTemplateRule](CppWCssTemplateRule.md)
-   [Wt::WCssTextRule](CppWCssTextRule.md)
-   [Wt::WDate](CppWDate.md)
-   [Wt::WDatePicker](CppWDatePicker.md)
...
-   [Wt::WDialog](CppWDialog.md)
-   [Wt::WDoubleValidator](CppWDoubleValidator.md)
...
-   [Wt::WFlashObject](CppWFlashObject.md)
-   [Wt::WFont](CppWFont.md)
-   [Wt::WFormWidget](CppWFormWidget.md)
-   [Wt::WGLWidget](CppWGLWidget.md)
-   [Wt::WGenericMatrix](CppWGenericMatrix.md)
-   [Wt::WGestureEvent](CppWGestureEvent.md)
-   [Wt::WGoogleMap](CppWGoogleMap.md)
-   [Wt::WGridLayout](CppWGridLayout.md)
-   [Wt::WGroupBox](CppWGroupBox.md)
-   [Wt::WHBoxLayout](CppWHBoxLayout.md)
-   [Wt::WHTML5Audio](CppWHTML5Audio.md)
-   [Wt::WHTML5Media](CppWHTML5Media.md)
-   [Wt::WHTML5Video](CppWHTML5Video.md)
-   [Wt::WIconPair](CppWIconPair.md)
-   [Wt::WImage](CppWImage.md)
-   [Wt::WInPlaceEdit](CppWInPlaceEdit.md)
-   [Wt::WIntValidator](CppWIntValidator.md)
...
-   [Wt::WLengthValidator](CppWLengthValidator.md)
...
-   [Wt::WMatrix4x4](CppWMatrix4x4.md)
-   [Wt::WMemoryResource](CppWMemoryResource.md)
-   [Wt::WMenu](CppWMenu.md)
-   [Wt::WMenuItem](CppWMenuItem.md)
-   [Wt::WMessageBox](CppWMessageBox.md)
-   [Wt::WMessageResourceBundle](CppWMessageResourceBundle.md)
-   [Wt::WModelIndex](CppWModelIndex.md)
...
-   [Wt::WProgressBar](CppWProgressBar.md)
...
-   [Wt::WScrollBar](CppWScrollBar.md)
-   [Wt::WScrollEvent](CppWScrollEvent.md)
-   [Wt::WSelectionBox](CppWSelectionBox.md)
-   [Wt::WServer](CppWServer.md)
-   [Wt::WShadow](CppWShadow.md)
-   [Wt::WSignalMapper](CppWSignalMapper.md)
-   [Wt::WSlider](CppWSlider.md)
-   [Wt::WSocketNotifier](CppWSocketNotifier.md)
-   [Wt::WSortFilterProxyModel](CppWSortFilterProxyModel.md)
-   [Wt::WSound](CppWSound.md)
-   [Wt::WSpinBox](CppWSpinBox.md)
-   [Wt::WStackedWidget](CppWStackedWidget.md)
-   [Wt::WStandardItem](CppWStandardItem.md)
-   [Wt::WStandardItemModel](CppWStandardItemModel.md)
-   [Wt::WStaticModelView](CppWStaticModelView.md)
-   [Wt::WString](CppWString.md)
-   [Wt::WStringListModel](CppWStringListModel.md)
-   [Wt::WSubMenuItem](CppWSubMenuItem.md)
-   [Wt::WSuggestionPopup](CppWSuggestionPopup.md)
-   [Wt::WSvgImage](CppWSvgImage.md)
-   [Wt::WTabWidget](CppWTabWidget.md)
-   [Wt::WTable](CppWTable.md)
-   [Wt::WTableCell](CppWTableCell.md)
-   [Wt::WTableColumn](CppWTableColumn.md)
-   [Wt::WTableRow](CppWTableRow.md)
-   [Wt::WTableView](CppWTableView.md)
...
-   [Wt::WTouchEvent](CppWTouchEvent.md)
-   [Wt::WTransform](CppWTransform.md)
-   [Wt::WTree](CppWTree.md)
-   [Wt::WTreeNode](CppWTreeNode.md)
-   [Wt::WTreeTable](CppWTreeTable.md)
-   [Wt::WTreeTableNode](CppWTreeTableNode.md)
-   [Wt::WTreeView](CppWTreeView.md)
-   [Wt::WVBoxLayout](CppWVBoxLayout.md)
-   [Wt::WValidationStatus](CppWValidationStatus.md)
-   [Wt::WValidator](CppWValidator.md)
-   [Wt::WVectorImage](CppWVectorImage.md)
-   [Wt::WViewWidget](CppWViewWidget.md)
-   [Wt::WVirtualImage](CppWVirtualImage.md)
-   [Wt::WVmlImage](CppWVmlImage.md)
-   [Wt::WWebWidget](CppWWebWidget.md)
-   [Wt::WWidget](CppWWidget.md)
-   [Wt::WWidgetItem](CppWWidgetItem.md)
-   [Wt](CppWt.md)::Coordinates
-   [Wt](CppWt.md)::WPen
...
Custom [Wt classes](CppWtClass.md)
-----------------------------------
