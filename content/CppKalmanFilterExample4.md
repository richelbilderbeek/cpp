...
([C++](Cpp.htm)) [Kalman filter example 4: single state, use of 1x1 boost::numeric::ublas::matrix and boost::numeric::ublas::vector](CppKalmanFilterExample4.htm)
=================================================================================================================================================================
...
boost::numeric::ublas::vector](CppKalmanFilterExample4.htm) is an
example to use a [Kalman filter](CppKalmanFilter.htm).
...
[Qt project file](CppQtProjectFile.htm): CppKalmanFilterExample4.pro
--------------------------------------------------------------------
