...
([C++](Cpp.md)) [QtExample1](CppQtExample1.md)
================================================
...
2D](CppQtExample1.md) is a [Qt example](CppQtExample.md) that shows an
...
[Qt project file](CppQtProjectFile.md): ./CppQtExample1/CppQtExample1.pro
--------------------------------------------------------------------------
