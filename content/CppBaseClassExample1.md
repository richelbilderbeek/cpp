...
([C++](Cpp.htm)) [BaseClassExample1](CppBaseClassExample1.htm)
==============================================================
...
[base class example 1](CppBaseClassExample1.htm) is an example of using
a [base class](CppBaseClass.htm).
...
[Qt project file](CppQtProjectFile.htm): ./CppBaseClassExample1/CppBaseClassExample1.pro
----------------------------------------------------------------------------------------
