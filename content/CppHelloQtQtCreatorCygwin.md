...
([C++](Cpp.htm)) [HelloQtQtCreatorCygwin](CppHelloQtQtCreatorCygwin.htm)
========================================================================

 

![Qt](PicQt.png)![Qt Creator](PicQtCreator.png)![Cygwin](PicCygwin.png)

 

[Hello Qt using Qt Creator under Cygwin](CppHelloQtQtCreatorCygwin.htm)
is a [Hello Qt](CppHelloQt.htm) program.

 

-   [Download the Qt Creator project
    'CppHelloQtQtCreatorCygwin' (zip)](CppHelloQtQtCreatorCygwin.zip)
...
[Qt project file](CppQtProjectFile.htm): ./CppHelloQtQtCreatorCygwin/CppHelloQtQtCreatorCygwin.pro
--------------------------------------------------------------------------------------------------
