...
([C++](Cpp.md)) [HelloQtQtCreatorCygwin](CppHelloQtQtCreatorCygwin.md)
========================================================================
...
[Hello Qt using Qt Creator under Cygwin](CppHelloQtQtCreatorCygwin.md)
is a [Hello Qt](CppHelloQt.md) program.
...
[Qt project file](CppQtProjectFile.md): ./CppHelloQtQtCreatorCygwin/CppHelloQtQtCreatorCygwin.pro
--------------------------------------------------------------------------------------------------
