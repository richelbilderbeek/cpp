...
([C++](Cpp.md)) [GetDeadEnds](CppGetDeadEnds.md)
==================================================

 

[GetDeadEnds](CppGetDeadEnds.md) is a [maze](CppMaze.md) [code
snippet](CppCodeSnippets.md) to obtain all the dead ends in a maze, for
