...
([C++](Cpp.htm)) [QGraphicsObjectExample3](CppQGraphicsObjectExample3.htm)
==========================================================================

 

[QGraphicsObject example 3: flashing
only](CppQGraphicsObjectExample3.htm) is a
[QGraphicsObject](CppQGraphicsObject.htm) [example](CppExample.htm). It
is a demonstration how to use an internal [QTimer](CppQTimer.htm) to
make the item flash.
...
[Qt project file](CppQtProjectFile.htm): ./CppQGraphicsObjectExample3/CppQGraphicsObjectExample3.pro
----------------------------------------------------------------------------------------------------
