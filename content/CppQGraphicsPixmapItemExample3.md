...
([C++](Cpp.md)) [QGraphicsPixmapItemExample3](CppQGraphicsPixmapItemExample3.md)
==================================================================================

 

[QGraphicsPixmapItem example 3: clickable and selectable
pixmap](CppQGraphicsPixmapItemExample3.md) is a
...
them respond to mouse clicks using a [boost::signal](CppBoostSignal.md)
...
[Qt project file](CppQtProjectFile.md): ./CppQGraphicsPixmapItemExample3/CppQGraphicsPixmapItemExample3.pro
------------------------------------------------------------------------------------------------------------
