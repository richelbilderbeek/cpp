...
([C++](Cpp.md)) ![Qt](PicQt.png) [Exercise: Qt hide and show \#2](CppExerciseQtHideAndShow2.md)
=================================================================================================
...
-   [View the answer](CppExerciseQtHideAndShow2Answer.md)
...
[Qt project file](CppQtProjectFile.md): CppExerciseQtHideAndShow2.pro
----------------------------------------------------------------------
