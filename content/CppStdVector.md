...
18. [RandomShuffle, shuffle a std::vector to a random order](CppStdRandomdomShuffle.md)
...
25. [Shuffle a std::vector to a random order, RandomShuffle](CppStdRandomdomShuffle.md)
