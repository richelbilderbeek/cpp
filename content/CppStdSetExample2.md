...
([C++](Cpp.md)) [StdSetExample2](CppStdSetExample2.md)
========================================================
...
std::set](CppStdSetExample2.md) is a [std::set](CppStdSet.md)
...
[Qt project file](CppQtProjectFile.md): ./CppStdSetExample2/CppStdSetExample2.pro
----------------------------------------------------------------------------------
