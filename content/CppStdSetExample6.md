...
([C++](Cpp.md)) [StdSetExample6](CppStdSetExample6.md)
========================================================
...
[std::set example 6](CppStdSetExample6.md) is a
[std::set](CppStdSet.md) [example](CppExample.md).
...
[Qt project file](CppQtProjectFile.md): ./CppStdSetExample6/CppStdSetExample6.pro
----------------------------------------------------------------------------------
