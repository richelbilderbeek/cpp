...
([C++](Cpp.md)) [StdSetExample4](CppStdSetExample4.md)
========================================================
...
in a custom order](CppStdSetExample4.md) is a [std::set](CppStdSet.md)
...
[Qt project file](CppQtProjectFile.md): ./CppStdSetExample4/CppStdSetExample4.pro
----------------------------------------------------------------------------------
