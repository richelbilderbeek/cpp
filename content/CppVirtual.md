...
-   If a [class](CppClass.md) has a [virtual](CppVirtual.md) [member
    ...
    [virtual](CppVirtual.md) [destructor](CppDestructor.md) \[4,8\]
...
2.  [Herb Sutter](CppHerbSutter.md), [Andrei
    ...
    destructors'
3.  [Herb Sutter](CppHerbSutter.md). [Exceptional
