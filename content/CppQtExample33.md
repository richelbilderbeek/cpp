...
([C++](Cpp.md)) [QtExample33](CppQtExample33.md)
==================================================
...
[Qt example 33: moveable and selectable arrows](CppQtExample33.md) is a
[Qt example](CppQtExample.md) to create some arrows that are (easily)
...
[Qt project file](CppQtProjectFile.md): ./CppQtExample33/CppQtExample33.pro
----------------------------------------------------------------------------
