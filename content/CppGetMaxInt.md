...
([C++](Cpp.htm)) [GetMaxInt](CppGetMaxInt.htm)
==============================================
...
[GetMaxInt](CppGetMaxInt.htm) is a [checking](CppCheck.htm) [code
...
[Qt project file](CppQtProjectFile.htm): ./CppGetMaxInt/CppGetMaxInt.pro
------------------------------------------------------------------------
