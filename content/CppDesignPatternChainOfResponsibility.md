...
([C++](Cpp.md)) [Chain Of Responsibility](CppDesignPatternChainOfResponsibility.md) ([Design Pattern](CppDesignPattern.htm))
==============================================================================================================================

 

The [Chain Of Responsibility](CppDesignPatternChainOfResponsibility.md)
is a [Design Pattern](CppDesignPattern.md) to 'avoid coupling the
