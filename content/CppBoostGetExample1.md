...
([C++](Cpp.md)) [BoostGetExample1](CppBoostGetExample1.md)
============================================================
...
[boost::get example 1](CppBoostGetExample1.md) is a
[boost::get](CppBoostGet.md) [example](CppExample.md).
...
[Qt project file](CppQtProjectFile.md): ./CppBoostGetExample1/CppBoostGetExample1.pro
--------------------------------------------------------------------------------------
