...
([C++](Cpp.htm)) [QtExample31](CppQtExample31.htm)
==================================================
...
[Qt example 31: moveable thin lines](CppQtExample31.htm) is a [Qt
example](CppQtExample.htm) to create some lines that are moveable. Note
that because the lines are one pixel thin, it is difficult to really
move them! [QtExample32](CppQtExample32.htm) solves this problem.
...
[Qt project file](CppQtProjectFile.htm): ./CppQtExample31/CppQtExample31.pro
----------------------------------------------------------------------------
